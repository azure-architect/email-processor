#!/usr/bin/env python3
"""
Claude Code sub_agent_stop hook for speaking subagent completion notifications.
"""
...
def main():
    ...
    log_json(input_data, prefix="sub_agent_stop")
    
    # Get the subagent information
    task_id = input_data.get("task_id", "unknown")
    status = input_data.get("status", "completed")
    
    # Create a notification message
    message = f"Subagent task {task_id} {status}."
